...
class Palette {
  ...
  static const Color barTheme = Colors.black; //aah my eyes theme, do it properly later
  ...
  // static const Color barTheme = Colors.white; //dark theme, do it properly later
